...
class MMEncoder:
    def __init__(
        ...
        logger.info(f"init MMEncoder {rank}/{get_parallel().configured_tp_size}")
        ...
        init_distributed_environment(
            ...
            world_size=get_parallel().configured_tp_size,
            rank=rank,
            distributed_init_method=dist_init_method,
            local_rank=rank,
        )
        initialize_model_parallel(
            tensor_model_parallel_size=get_parallel().configured_tp_size
        )
